...
function eventon_admin_menu() {
	...
	$main_page = add_menu_page(__('EventON - Event Calendar','eventon'), 'myEventON'.$evo_notification,'manage_options','eventon','eventon_settings_page', AJDE_EVCAL_URL.'/assets/images/eventon_menu_icon.png');
...
function eventon_admin_scripts() {
	...
	// JQuery UI Styles
	$calendar_ui_style_src = AJDE_EVCAL_URL.'/assets/css/jquery-ui-1.8.16.custom.css';
...
function eventon_admin_head() {
	...
	<style type="text/css">
		...
		<?php if ( isset($_GET['taxonomy']) && $_GET['taxonomy']=='event_type' ) : ?>
			.icon32-posts-ajde_events { background-position: -83px -0px !important; }
