...
function roots_scripts() {
  ...
  wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/main.min.css', false, 'be1b9c9b242c45d08232d98bdb2433a6');
  ...
  wp_register_script('roots_scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', array('angular'), 'ada2e4ea6e0134eb2dc763612eb12368', true);
